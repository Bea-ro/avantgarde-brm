...
profiles: [
    ...
    { link: 'https://linkedin.com/in/beatrizrodriguezmaya/', icon: '/icons/linkedin-icon.png', name: 'LinkedIn' },
    { link: 'https://developer-portfolio-brm.netlify.app/', icon: '/icons/portfolio-icon.png', name: 'Portfolio' },
  ],
techs: [
